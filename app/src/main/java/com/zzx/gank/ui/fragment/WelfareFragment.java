...
import com.zzx.gank.ui.adatper.WelfareAdapter;
...
public class WelfareFragment extends BaseFragment<TypePresenter> implements ITypeView, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void initView() {
        ...
        mAdapter = new WelfareAdapter(getActivity(), mDatas);
    ...
    public void onItemClick(View view, int position) {
        if (mDatas != null && mDatas.size() > 0) {
            ...
            if (gank != null) {
                PicAcitvity.show(getActivity(), view, gank.url);
            }
        }
    }
}
